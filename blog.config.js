...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Quartex', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'I am learning to make sounds', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://quartexounds.xyz', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hello., Nice to meet you., Welcome to my humble place.',
